...
// DeviceFingerprintCollector Linux存根
...
func (c *DeviceFingerprintCollector) CollectFingerprint() (*DeviceFingerprint, error) {
	...
	return &DeviceFingerprint{
		DeviceID:          "linux-stub-device",
		DeviceType:        "server",
		CPUID:             "stub-cpu-id",
		CPUModel:          "Linux Stub CPU",
		CPUCores:          4,
		MemorySize:        8192,
...
func (s *LicenseService) GetLicenseInfo(license string) (*LicenseInfo, error) {
	return &LicenseInfo{
